...
similar_to_nation = all_prez_embeddings.most_similar('nation', topn= 20)

similar_to_war = all_prez_embeddings.most_similar('war', topn = 20)

similar_to_texas = all_prez_embeddings.most_similar('texas', topn = 20)

#print(similar_to_freedom)
#print(similar_to_texas)
#print(similar_to_war)
#print(similar_to_nation)
